...
# Juego simple contra la computadora: segunda versión
import random
import math
opciones = ["piedra", "papel", "tijera"]
print("¡Bienvenido! Vamos a jugar a Piedra, Papel o Tijera.")
print("escribe la cantidad de rondas a jugar")
rondas_totales = int(input("rondas a jugar: "))
rondas_ganar = rondas_totales
...
while ronda <= rondas_totales:
    ...
    if jugada_usuario == jugada_pc:
        ...
        puntos_pc += 1
    if puntos_usuario == math.ceil(rondas_ganar/2):
        ronda = rondas_totales
    if puntos_pc == math.ceil(rondas_ganar/2):
        ronda = rondas_totales
    ronda += 1
print("\n=== Resultado final ===")
